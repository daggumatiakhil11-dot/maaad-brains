...
export default function Home() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://maaad-backend.onrender.com/search?query=${encodeURIComponent(query)}`
      );
  ...
  return (
    ...
    <main className="h-screen bg-black overflow-hidden text-white relative">
      ...
      <div className="relative z-20 flex items-center justify-between px-6 py-4 border-b border-cyan-500/10 backdrop-blur-2xl">
        ...
        <div className="text-zinc-500 uppercase tracking-[0.3em] text-xs">
          MAAAD BRAINS • SEARC ENGINE
        </div>

      </div>

      <div className="relative z-10 p-2 scale-[0.82] origin-top">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none overflow-hidden">
          ...
          <motion.div
            ...
            className="absolute w-[900px] h-[900px] rounded-full border border-cyan-400/10"
          />
          ...
          <motion.div
            ...
            className="absolute w-[700px] h-[700px] rounded-full border border-cyan-400/10"
          />
        ...
        <div className="grid grid-cols-12 gap-5 h-[calc(100vh-90px)]">

          {/* LEFT */}

          <div className="col-span-3">

            <div className="bg-white/5 backdrop-blur-3xl border border-cyan-500/20 rounded-[40px] p-6 h-full overflow-y-auto shadow-[0_0_100px_rgba(0,255,255,0.08)]">
          ...
          <div className="col-span-6">
            ...
            <div className="relative mb-8">
              ...
              >
                ...
                <span className="text-green-400 uppercase tracking-[0.4em] text-sm">
            ...
            {displayedSummary && (
              ...
              <motion.div
                ...
                className="bg-white/5 backdrop-blur-3xl border border-cyan-500/20 rounded-[40px] p-10"
              >
              ...
              <div className="flex justify-center mb-8">
                ...
                >
                  ...
                  <motion.div
                    ...
                    className="absolute inset-[-40px] rounded-full border border-green-400/10"
                  />

                  <div className="absolute inset-0 bg-cyan-400 blur-[150px] opacity-30 rounded-full"></div>
                  ...
                  <Image
                    ...
                    width={150}
                    height={150}
                    className="relative rounded-full border border-cyan-400/30 shadow-[0_0_150px_rgba(0,255,255,0.25)]"
                    priority
                  />
